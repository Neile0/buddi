    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bio', models.CharField(max_length=300)),
                ('profile_image', models.ImageField(blank=True, default='profile_images/profile_image_placeholder.png', upload_to=buddi.models.UserProfile.profile_image_upload)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(default='No message', max_length=400)),
                ('made_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buddi.userprofile')),
                ('sitter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buddi.sitter')),
            ],
            options={
